    ...
    fProxyIpValid(true)
{
    ...
    ui->proxyPort->setValidator(new QIntValidator(1, 3011, this));
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Arkenstone."), QMessageBox::Ok);
