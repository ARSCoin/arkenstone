...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click arkenstone: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start arkenstone: click-to-pay handler");
    else
...
{
    // clicking on arkenstone: URLs creates FileOpen events on the Mac:
