...
{
    CService addr;
    if (!LookupNumeric(src.c_str(), addr, 3011))
        return canon == "";
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:3011"));
    BOOST_CHECK(TestParse("127.0.0.1:8333", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:3011"));
    BOOST_CHECK(TestParse("::", "[::]:3011"));
